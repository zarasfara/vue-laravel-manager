<template>
  <header>
    <nav class="bg-white/70 border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-2xl">
        <a href="https://flowbite.com" class="flex items-center">
          <img src="https://flowbite.com/docs/images/logo.svg" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo"/>
          <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Dvizh</span>
        </a>
        <!--Модалка-->
        <div class="modal">
        ...
        <div class="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
          <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li v-if="user">
              <a href="api/logout"
                 class="block py-2 pr-4 pl-3 text-white rounded bg-primary-700 lg:bg-transparent text-gray-700 lg:p-0 dark:text-white"
